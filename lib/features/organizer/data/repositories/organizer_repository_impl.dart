...
class OrganizerRepository implements IOrganizerRepository {
  ...
  Future<Either<Failure, OrganizerEntity>> addVerificationDocuments(
    ...
    try {
      ...
      return Left(ApiFailure.fromDioException(e, fallback: 'Failed to add documents'));
    } catch (e) {
      return Left(ApiFailure(message: e.toString()));
    }
  }
  ...
  Future<Either<Failure, OrganizerEntity>> removeVerificationDocument(
    ...
    try {
      ...
      return Left(ApiFailure.fromDioException(e, fallback: 'Failed to remove document'));
    } catch (e) {
      return Left(ApiFailure(message: e.toString()));
    }
  }
  ...
  Future<Either<Failure, OrganizerEntity>> updateActiveStatus(
    ...
    try {
      ...
      return Left(ApiFailure.fromDioException(e, fallback: 'Failed to update status'));
    } catch (e) {
      return Left(ApiFailure(message: e.toString()));
    }
  }
