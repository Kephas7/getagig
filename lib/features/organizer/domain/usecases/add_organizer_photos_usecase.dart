...
final addOrganizerPhotosUseCaseProvider = Provider<AddOrganizerPhotosUseCase>((ref) {
  final repository = ref.read(organizerRepositoryProvider);
  return AddOrganizerPhotosUseCase(repository: repository);
});

class AddOrganizerPhotosUseCase implements UsecaseWithParms<OrganizerEntity, List<File>> {
  final IOrganizerRepository _repository;

  AddOrganizerPhotosUseCase({required IOrganizerRepository repository})
