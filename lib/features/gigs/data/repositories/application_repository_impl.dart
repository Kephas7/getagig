...
class ApplicationRepository implements IApplicationRepository {
  ...
  Future<Either<Failure, List<ApplicationModel>>> getMyApplications() async {
    try {
      ...
      return Left(ApiFailure.fromDioException(e, fallback: 'Failed to fetch applications'));
    } catch (e) {
  ...
  @override
  Future<Either<Failure, List<ApplicationModel>>> getGigApplications(String gigId) async {
    try {
      ...
      return const Left(ApiFailure(message: 'Failed to fetch gig applications'));
    } on DioException catch (e) {
      return Left(ApiFailure.fromDioException(e, fallback: 'Failed to fetch gig applications'));
    } catch (e) {
      return Left(ApiFailure(message: e.toString()));
    }
  }
  ...
  @override
  Future<Either<Failure, ApplicationModel>> apply(String gigId, String coverLetter) async {
    try {
      ...
      if (response.data['success'] == true) {
        return Right(ApplicationModel.fromJson(response.data['data']));
      }
      return const Left(ApiFailure(message: 'Failed to apply for gig'));
    } on DioException catch (e) {
      return Left(ApiFailure.fromDioException(e, fallback: 'Failed to apply for gig'));
    } catch (e) {
      return Left(ApiFailure(message: e.toString()));
    }
  }
  ...
  @override
  Future<Either<Failure, bool>> updateStatus(String applicationId, String status) async {
    try {
      ...
      return const Left(ApiFailure(message: 'Failed to update application status'));
    } on DioException catch (e) {
      return Left(ApiFailure.fromDioException(e, fallback: 'Failed to update application status'));
    } catch (e) {
      return Left(ApiFailure(message: e.toString()));
    }
  }
