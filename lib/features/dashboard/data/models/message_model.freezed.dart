...
@JsonSerializable()
@HiveType(
    typeId: HiveTableConstant.messageTypeId, adapterName: 'MessageModelAdapter')
class _$MessageModelImpl implements _MessageModel {
  const _$MessageModelImpl(
      {@HiveField(0) @JsonKey(name: '_id', readValue: _readId) this.id,
      @HiveField(1) this.conversationId,
...
abstract class _MessageModel implements MessageModel {
  const factory _MessageModel(
      ...
      @HiveField(5) final DateTime? createdAt}) = _$MessageModelImpl;
